...
<li class="selected"><a HREF="javascript:void(0);" onClick="return showLayer('seminar');"><img src="images/icons/seminar.png" title="Seminar" border="0" /><? if($seminarcount >= 1){echo "&nbsp;<img src=\"images/checkmark.gif\" border=\"0\">";}?></a></li>
...
<li><a HREF="javascript:void(0);" onClick="return showLayer('new_pt_sht');"><img src="images/icons/patient-icon.png" title="Patient Sheet" border="0" /></a></li>
