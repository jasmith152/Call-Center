...
<li class="selected"><a HREF="javascript:void(0);" onClick="return showLayer('films_mri');">Films/MRI<? if($film_recd == 1){echo "&nbsp;<img src=\"images/checkmark.gif\" border=\"0\">";}?></a></li>
