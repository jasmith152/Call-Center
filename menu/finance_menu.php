...
<li class="selected"><a HREF="javascript:void(0);" onClick="return showLayer('finance');"><img src="images/icons/finance.png" title="Finance" border="0" /><? if($fin_stat){echo " ".$fin_stat_menu;} ?></a></li>
