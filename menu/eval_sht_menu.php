...
<li class="selected"><a HREF="javascript:void(0);" onClick="return showLayer('eval_sht');">Eval. Sht.<? if($lcc_eval_sht_id){echo "&nbsp;<img src=\"images/checkmark.gif\" border=\"0\">";}?></a></li>
