...
<li class="selected"><a HREF="javascript:void(0);" onClick="return showLayer('mri_cons');">MRI/Consult<? if($mriconscount >= 1){echo "&nbsp;<img src=\"images/checkmark.gif\" border=\"0\">";}?></a></li>
